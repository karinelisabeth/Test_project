...
class ProductCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create product_category" do
    assert_difference('ProductCategory.count') do
      post :create, product_categories: { cat_name: @product_category.cat_name }
    end

    assert_redirected_to product_category_path(assigns(:product_categories))
  end
  ...
  test "should update product_category" do
    patch :update, id: @product_category, product_categories: { cat_name: @product_category.cat_name }
    assert_redirected_to product_category_path(assigns(:product_categories))
  end
